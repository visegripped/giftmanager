import { useState, createContext, useEffect, useCallback, PropsWithChildren, useContext } from "react";
...
function AuthProvider(props: PropsWithChildren) {
  ...
  const [accessTokenExpiration, setAccessTokenExpiration] = useState<Date | string>(
    localStorage.getItem("access_token_expiration") || ""
  );

  const { addNotification } = useContext<AddNotificationProps>(NotificationsContext);
